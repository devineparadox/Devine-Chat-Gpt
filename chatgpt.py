...
from config import API_ID, API_HASH, BOT_TOKEN, OPENAI_KEY, BOT_NAME, BOT_USERNAME, OWNER_USERNAME, OWNER_ID, SUPPORT_GROUP, START_IMG, UPDATE_CHANNEL
...
MAIN_BUTTONS = [
    ...
    [
        InlineKeyboardButton(
            text="ᴅᴇᴠᴇʟᴏᴘᴇʀ",
            url="tg://openmessage?user_id=6096082088"),
